...
he was visiting locations that are historically significant to the North Pole; a group of Senior Historians have asked you to
...
number in the left list with the smallest number in the right list, then the second-smallest left number with the second-smallest right number,
and so on.
...
3 from the left list with a 7 from the right list, the distance apart is 4; if you pair up a 9 with a 3, the distance apart is 6.
...
The Historians can't agree on which group made the mistakes or how to read most of the Chief's handwriting, but
in the commotion you notice an interesting detail: a lot of location IDs appear in both lists! Maybe the other
